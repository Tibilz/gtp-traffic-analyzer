...
void callback_n3(u_char *user, const struct pcap_pkthdr *h, const u_char *bytes) {
    ...
    // **2. Bestimme die Anzahl der zu überspringenden Bytes basierend auf dem Protokoll**
    ...
    // **4. Füge das N3-Paket in die Hashmap ein**
...
void callback_n6(u_char *user, const struct pcap_pkthdr *h, const u_char *bytes) {
    ...
    // **4. Versuche, das N6-Paket mit einem N3-Paket abzugleichen**
